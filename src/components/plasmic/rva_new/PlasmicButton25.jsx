...
import * as sty from "./PlasmicButton25.module.css" // plasmic-import: LR9nDSbmSEME/css
...
export const PlasmicButton25__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton25__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nnCmF)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg__gdAtx)}
                role={"img"}
              />
            ),
