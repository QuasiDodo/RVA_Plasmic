...
import * as sty from "./PlasmicButton21.module.css" // plasmic-import: A-CHM3NpvTPd/css
...
export const PlasmicButton21__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton21__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___5JlN)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg__qyXrO)}
                role={"img"}
              />
            ),
