...
import * as sty from "./PlasmicButton11.module.css" // plasmic-import: ilrdrVgKIxu6/css
...
export const PlasmicButton11__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton11__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__vx0VN)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg__ikN9K)}
                role={"img"}
              />
            ),
