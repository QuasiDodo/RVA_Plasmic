...
import * as sty from "./PlasmicButton15.module.css" // plasmic-import: n0VxP9nvA2uW/css
...
export const PlasmicButton15__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton15__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__k1Ljm)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg___2E2Kx)}
                role={"img"}
              />
            ),
