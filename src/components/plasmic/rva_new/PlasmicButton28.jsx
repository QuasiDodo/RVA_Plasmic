...
import * as sty from "./PlasmicButton28.module.css" // plasmic-import: RoFRjc3cT2p2/css
...
export const PlasmicButton28__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton28__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicButton28__RenderFunc(props) {
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__oB7Nc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon5Icon
                className={classNames(projectcss.all, sty.svg___53VPy)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButton28__ArgProps,
          internalVariantPropNames: PlasmicButton28__VariantProps,
        }),

      [props, nodeName]
    )

    return PlasmicButton28__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButton28"
  } else {
    func.displayName = `PlasmicButton28.${nodeName}`
  }
  return func
}

export const PlasmicButton28 = Object.assign(
  // Top-level PlasmicButton28 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButton28
    internalVariantProps: PlasmicButton28__VariantProps,
    internalArgProps: PlasmicButton28__ArgProps,
    useBehavior,
  }
)

export default PlasmicButton28
/* prettier-ignore-end */
